  ...
  return (
    <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className="relative w-full">
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto scroll-smooth py-10 [scrollbar-width:none] md:py-20 select-none"
          ref={carouselRef}
...
export const BlurImage = ({
  ...
  className,
  alt,
  fill, // Destructure to ignore
  blurDataURL, // Destructure to ignore
  ...rest
}) => {
