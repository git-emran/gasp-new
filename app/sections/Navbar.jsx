  ...
  return (
    <>
      <div className={isReady ? "block" : "hidden"}>
        <nav
          ref={navRef}
          className="fixed top-0 left-0 z-50 flex flex-col justify-between w-full h-full px-10 uppercase bg-black text-white/80 py-10 gap-y-10 md:w-1/2 md:left-1/2"
        >
      ...
      <div
        className="fixed z-50 flex flex-col items-center justify-center gap-1 transition-all duration-300 bg-black rounded-full cursor-pointer w-14 h-14 md:w-20 md:h-20 top-4 right-4 md:right-10"
        onClick={toggleMenu}
        style={
          showBurger
